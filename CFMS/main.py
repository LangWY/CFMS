...
import torch
import random
from models.models import CFMS
...
def parse_agrs():
    ...
    parser.add_argument('--label_path', type=str, default='data/iu_xray/labels.pickle',
                        help='the path to the directory containing the data.')  # data/iu_xray/labels/labels_14.pickle

    parser.add_argument('--img_init_protypes_path', type=str, default='data/iu_xray/init_protypes_512.pt',
                        help='the path to the directory containing the data.')  # data/iu_xray/init_prototypes.pt
